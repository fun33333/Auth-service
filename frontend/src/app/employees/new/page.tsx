          ...
          <div className="flex items-center justify-between pt-8 border-t border-slate-50 mt-10">
            ...
            {step < 4 ? (
              ...
              <button
                ...
                className="inline-flex items-center gap-3 px-10 h-14 text-[10px] font-black uppercase tracking-widest text-white bg-emerald-500 rounded-2xl hover:bg-emerald-600 disabled:opacity-60 transition-all active:scale-95 shadow-xl shadow-emerald-500/20"
              >
                {isSubmitting ? (
                  <><Loader2 size={18} className="animate-spin" /> Saving Records…</>
                ) : (
                  <><Check size={18} strokeWidth={3} /> Finalize Creation</>
                )}
              </button>
            )}
          </div>
